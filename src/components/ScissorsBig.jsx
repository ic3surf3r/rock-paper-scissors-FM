    ...
    <div className="flex items-center justify-center ">
      <div className="relative m-auto flex items-center justify-center">
        ...
        >
          ...
          <div className="absolute rounded-full bg-white-shadow w-40 h-40 z-30"></div>
        </div>
        <div className="absolute rounded-full bg-scissors-shadow w-48 h-48 z-30 -bottom-2"></div>
      </div>
    </div>
  );
}
